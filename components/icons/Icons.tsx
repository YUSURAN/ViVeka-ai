...
export const ExpertIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="m20 14-1.5 1.5M16 18h6" />
        <path d="m18 20 1.5-1.5" />
        <path d="M19 15v6" />
    </svg>
);
...
export const EducationIcon: React.FC<{className?: string}> = ({ className }) => (
    // FIX: Corrected typo in SVG element from 'sv' to 'svg'.
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M22 10v6M2 10l10-5 10 5-10 5z"></path>
        <path d="M6 12v5c0 1.7.9 3.2 2.3 4"></path>
        <path d="M18 12v5a4 4 0 0 1-4 4h-1"></path>
    </svg>
);
...
export const QuizIcon: React.FC<{className?: string}> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        ...
        <path d="M19 11V9a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v1" />
        <path d="M5 15V9a2 2 0 0 1 2-2h2" />
        <path d="M19 13a2 2 0 0 1 2 2v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4a2 2 0 0 1 2-2h2" />
        <path d="M12 18h.01" />
    </svg>
);
